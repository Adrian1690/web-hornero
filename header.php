    ...
    <div class="container-fluid">
		...
		<div id="navbar" class="navbar-collapse collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="item-nav active"><a href="#">Historia</a></li>
				<li class="item-nav" ><a href="#">La carta</a></li>
				<li class="item-nav" ><a href="#">Eventos</a></li>
				<li class="item-nav" ><a href="#">Galeria</a></li>
				<li class="item-nav margin-right-10em" ><a href="#">Reservas</a></li>
