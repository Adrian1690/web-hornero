...
<body cz-shortcut-listen="true">
	...
	<section id="events_section" class="contenedor">
		...
		<div id="reserve-content" class="text-center">
			<div class="row">
				<div class="col-md-6">
					<div class="title-all" style="padding-top:0;">
						ASIA
					...
					<div class="info-reserve">
						...
						<div class="address-reserve">
							Panamericana Sur Km. 97.50, Boulevard de Asia - Cañete
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					...
					<div class="info-reserve">
						...
						<div class="address-reserve">
							Av. Circunvalación del Golf 408, Camacho - La Molina
						</div>
					</div>
				</div>
			</div>
